...
/**promise  chaining working

Yes, in a promise chaining scenario, when you use the then() method, each subsequent then() call registers a callback for the new promise returned by the previous then()

In this example, each then() method is called on the promise returned by the previous then() method. Each then() registers a callback for the new promise created by the previous then().

2nd then only work when 1st than return an promise

p.then().then

p resolve ,1st then register cb get call and return an promise than 2nd then register an cb for this new promise
*/